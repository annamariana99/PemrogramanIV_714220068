...
import 'package:p10_714220068/data_service.dart';
import 'package:p10_714220068/user.dart';
import 'package:p10_714220068/user_card.dart';
import 'package:p10_714220068/user_put.dart';
                      ...
                      onPressed: () async {
                        ...
                        try {
                          ...
                          UserCreate? res = await _dataService.putUser(
                              '123', putModel.name, putModel.job);
                          if (res != null) {
                            setState(() {
                              _result = res.toString();
                              usCreate =
                                  res; // Tetapkan objek UserCreate ke usCreate
                            });
